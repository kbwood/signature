	...
	var config = {
			...
			dist: {
				...
				replacements: [
					...
					},
					{
						...
						to: 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js'
					}
				]
			},
			testmin: {
				src: ['test/signature.tests.html'],
				dest: 'test/signature.min.tests.html',
				replacements: [
				    {
		...
		zip: {
			all: {
				...
				dest: 'dist/jquery.signature.package-<%= pkg.version %>.zip'
			}
		}
	};
